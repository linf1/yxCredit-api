package com.zw.service.common.dao.impl;
...
public class DaoSupportImpl implements IDaoSupport {
    ...
    public Map findForMap(String sql) throws DAOException {
        try {
            TraceLoggerUtil.info("执行SQL:" + sql);
            Map map = this.sqlSessionTemplate.selectOne("DaoSupportMapper.selectSql", sql);
    ...
    public List<Map> findForList(String sql) throws DAOException {
        try {
            TraceLoggerUtil.info("执行SQL:" + sql);
            List<Map> list = this.sqlSessionTemplate.selectList("DaoSupportMapper.selectSql", sql);
    ...
    public int getCount(String sql) throws DAOException {
        try {
            TraceLoggerUtil.info("执行SQL:" + sql);
            int count = sqlSessionTemplate.selectOne("DaoSupportMapper.countSql", sql);
