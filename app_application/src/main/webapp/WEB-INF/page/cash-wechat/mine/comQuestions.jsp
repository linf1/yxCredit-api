...
<div style="margin-top: 50px" id="comQuestion">
    <c:forEach items="${data}" var="item" >
        <div class="weui-cells">
            <p class="questions"><span class="moreIcon">&quest;</span><span ><c:out value="${item.key}"/></span><span class="right getMore">更多</span></p>
            <c:forEach items="${item.value}" var="item" begin="0" varStatus="itemStatss" end="3">
...
<c:forEach items="${data}" var="item" >
    <div style="margin-top: 50px;display: none" id="comQuestionDetail_${item.key}">
        <div class="weui-cells">
