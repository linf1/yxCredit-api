...
<head>
    ...
    <script src="${ctx}/resources/cash-wechat/js/centerMsg/contract.js${version}"></script>
    <style>
        #confirmContract{
            position: absolute;
            right: 15px;
...
<body  style="background:#f6f6f6">
    ...
    <div class="toolBar">
        <p><span class="icon-back" onclick="history.go(-1)"></span><span>合同详情</span><span id="confirmContract" style="display: none">${param.word}</span></p>
    </div>
    ...
    <div class="scroll-wrapper" style="-webkit-overflow-scrolling: touch;overflow-y: scroll;position: fixed;top: 50px;bottom: 0px;left: 0px;right: 0px;">
